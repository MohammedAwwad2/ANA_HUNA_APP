...
class LLMPage extends StatefulWidget {
  ...
  @override
  State<LLMPage> createState() => _LLMPage();
}

class _LLMPage extends State<LLMPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'قم بالإشارة للكاميرا وسيتم عرض أجوبة الروبوت هنا',
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: CusButton(
                        onTap: h.currentSentence.isNotEmpty ? h.llm : null,
                        icon: Icons.send,
                        label: 'سؤال',
